...
copy .\doc\statictiddlers\tiddlywiki.info .\tmp\tiddlypettil\
copy .\doc\statictiddlers\*.tid .\tmp\tiddlypettil\tiddlers\ >NUL
set mydate=doc generated %date:~10,4%-%date:~4,2%-%date:~7,2%
sed "s/datetimestamp/%mydate%/" ./doc/statictiddlers/AboutPETTIL.tid >./tmp/tiddlypettil/tiddlers/AboutPETTIL.tid
cd .\tmp\tiddlypettil & tiddlywiki --load ../pettil.json --output ../../doc/ --rendertiddler $:/core/save/all tiddlypettil.html text/plain >NUL & cd ..\..
